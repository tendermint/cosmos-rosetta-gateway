...
func TestLaunchpad_Block(t *testing.T) {
	...
	//	}
	//
	//	adapter := NewLaunchpad(TendermintAPI{Info: mt}, mc, ma, properties)
	//
	//	var h int64 = 1
	...
	//	}
	//
	//	adapter := NewLaunchpad(TendermintAPI{}, mc, alttendermint.NewClient(""), properties)
	//
